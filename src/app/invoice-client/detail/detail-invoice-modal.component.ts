...
export class DetailInvoiceModalComponent implements OnInit {
  ...
  constructor(public modalService: ModalServiceService, public clientService: ClientService, public authService: AuthService) { }
      ...
      this.clientService.uploadTicket(this.selectPhoto, id).subscribe(
        event => {
          if(event.type === HttpEventType.UploadProgress) {
            ...
            Swal.fire('La foto se ha subido completamente, vuelva  esta página en unos segundos para ver la imágen!', response.Mensaje, 'success');
          }
        });
    }
  }
